...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2023 at 02:57 PM
...
INSERT INTO `transaksi` (`id_transaksi`, `email`, `id_paket`, `nama_paket`, `tanggal`, `bukti_tf`) VALUES
(18, 'ikhsan@gmail.com', 9, 'Golden', '2023-07-07', 'bukti_tf.png'),
(19, 'rafi@gmail.com', 2, 'Reguler 1', '2023-07-09', 'WhatsApp Image 2023-07-01 at 13_56_11.jpeg');
...
(30, 'Ikhsan', 'ikhsan@gmail.com', 'default.jpg', '$2y$10$wcRx72Fu9OUUCsKTgqKoeuqIA4kUvgZJjHhr4DVop4ukmFqfYdU3G', 1, 1, 1688650866);
...
(12, 7, 'My Package', 'user/mypackage', 'fas fa-fw fa-columns', 1),
(13, 8, 'Transaksi', 'transaksi', 'fas fa-fw fa-columns', 1),
(14, 1, 'Transaksi', 'transaksi', 'fas fa-fw fa-columns', 1);
